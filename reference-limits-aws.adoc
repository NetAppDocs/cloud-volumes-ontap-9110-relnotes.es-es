...
| *Freemium* | 24 equipos virtuales de almacenamiento total hacia 1,2 


| *PAYGO basado en la capacidad o BYOL* esta 3 | 24 equipos virtuales de almacenamiento total hacia 1,2 
...
| *BYOL* basado en nodos con esta versión 4 | 24 equipos virtuales de almacenamiento total hacia 1,2 
|===
